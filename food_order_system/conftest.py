...
from food_order_system.db.dependencies import get_db_session
from food_order_system.db.utils import create_database, drop_database
from food_order_system.services.rabbit.dependencies import get_rmq_channel_pool
...
from food_order_system.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from food_order_system.db.meta import meta  # noqa: WPS433
    from food_order_system.db.models import load_all_models  # noqa: WPS433
